...
const App = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 pb-20 font-sans">
      <nav className="bg-white/80 backdrop-blur-md border-b sticky top-0 z-40 px-6 h-16 flex items-center justify-between shadow-sm">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8 grid grid-cols-1 lg:grid-cols-4 gap-8">
        <aside className="lg:col-span-1 space-y-6">
          <div className="bg-white p-6 rounded-3xl border shadow-sm space-y-6 lg:sticky lg:top-24 h-fit max-h-[calc(100vh-8rem)] overflow-y-auto custom-scrollbar pr-2">
            <div>
        ...
        <div className="lg:col-span-3 space-y-8">
          ...
          <div className="space-y-6">
            {essays.map(essay => {
              ...
              return (
                <div key={essay.id} className="bg-white p-6 rounded-3xl border-2 border-slate-200 shadow-sm flex flex-col md:flex-row gap-6 hover:shadow-md hover:border-indigo-300 transition-all">
